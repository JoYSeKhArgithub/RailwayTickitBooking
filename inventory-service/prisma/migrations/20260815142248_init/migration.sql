...
CREATE TABLE "seat_inventories" (
    "id" TEXT NOT NULL,
    "scheduleInvetoryId" TEXT NOT NULL,
    "scheduleId" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "seat_segment_locks_lockedExpiresAt_status_idx" ON "seat_segment_locks"("lockedExpiresAt", "status");

-- CreateIndex
CREATE INDEX "seat_segment_locks_bookingId_idx" ON "seat_segment_locks"("bookingId");

-- CreateIndex
CREATE UNIQUE INDEX "idempotency_record_eventKey_key" ON "idempotency_record"("eventKey");

-- CreateIndex
CREATE INDEX "idempotency_record_eventKey_idx" ON "idempotency_record"("eventKey");

-- AddForeignKey
ALTER TABLE "seat_inventories" ADD CONSTRAINT "seat_inventories_scheduleInvetoryId_fkey" FOREIGN KEY ("scheduleInvetoryId") REFERENCES "schedule_inventories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
